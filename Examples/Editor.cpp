...
class ModelViewer : public FishEditor::GLFWGameApp
{
public:
	void Start() override
	{
...
//		path = GetglTFSample("DamagedHelmet");
...
//		rootGO->GetTransform()->SetLocalEulerAngles(0, 90, 0);
...
{
	ModelViewer demo;
//	demo.m_WindowWidth = 1280;
//	demo.m_WindowHeight = 960;
	demo.Run();
	return 0;
}
